...
<section id="<?php echo esc_attr( $anchor ); ?>" class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>" <?php echo wp_kses_post( $attrs ); ?>>
	<div class="container">
		<div class="row">
			<div class="col-12 contact__content">
				<h2 class="contact__title onscroll has-h-3-font-size">
					<?php echo wp_kses_post( $content['heading'] ); ?>
				</h2>
				<div class="contact__address onscroll">
					<?php echo wp_kses_post( $content['address'] ); ?>
				</div>
				<div class="contact__buttons">
					<a class="contact__phone onscroll" href="tel:<?php echo esc_html( str_replace( array( ' ', '-' ), '', $content['phone_number'] ) ); ?>">
						...
						<?php echo esc_html( $content['phone_number'] ); ?>
					</a>
					<a class="contact__email onscroll" href="mailto:<?php echo esc_html( $content['email_address'] ); ?>">
						<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
						...
						<?php echo esc_html( $content['email_address'] ); ?>
					</a>
				</div>
			</div>
		</div>
